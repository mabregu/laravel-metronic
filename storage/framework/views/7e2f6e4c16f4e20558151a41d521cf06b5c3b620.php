...
<div class="card card-custom bg-gray-100 <?php echo e(@$class); ?>">
        ...
        <div class="card-spacer mt-n25">
            ...
            <div class="row m-0">
                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                    <?php echo e(Metronic::getSVG("media/svg/icons/Media/Equalizer.svg", "svg-icon-3x svg-icon-warning d-block my-2")); ?>
                ...
                <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                    <?php echo e(Metronic::getSVG("media/svg/icons/Communication/Add-user.svg", "svg-icon-3x svg-icon-primary d-block my-2")); ?>
            ...
            <div class="row m-0">
                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                    <?php echo e(Metronic::getSVG("media/svg/icons/Design/Layers.svg", "svg-icon-3x svg-icon-danger d-block my-2")); ?>
                ...
                <div class="col bg-light-success px-6 py-8 rounded-xl">
                    <?php echo e(Metronic::getSVG("media/svg/icons/Communication/Urgent-mail.svg", "svg-icon-3x svg-icon-success d-block my-2")); ?>
...
<?php /**PATH C:\wamp64\www\keenthemes\themes\metronic\theme\html_laravel\demo1\skeleton\resources\views/pages/widgets/_widget-1.blade.php ENDPATH**/ ?>